-file("/usr/local/stow/erlang-19.1.6/lib/erlang/lib/parsetools-2.1.3/include/leexinc.hrl", 0).
...
-file("./day10_lexer.xrl", 19).

-file("/usr/local/stow/erlang-19.1.6/lib/erlang/lib/parsetools-2.1.3/include/leexinc.hrl", 14).
...
yystate(21, [10|Ics], Line, Tlen, _, _) ->
    yystate(21, Ics, Line+1, Tlen+1, 4, Tlen);
...
yystate(18, [119|Ics], Line, Tlen, Action, Alen) ->
...
yystate(15, [112|Ics], Line, Tlen, Action, Alen) ->
...
-file("./day10_lexer.xrl", 10).
yyaction_0(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("./day10_lexer.xrl", 11).
yyaction_1(TokenChars, TokenLine) ->
     { token, { verb, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("./day10_lexer.xrl", 12).
yyaction_2(TokenChars, TokenLine) ->
     { token, { chip, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("./day10_lexer.xrl", 13).
yyaction_3(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_4/0}).
-file("./day10_lexer.xrl", 14).
yyaction_4() ->
     skip_token .

-compile({inline,yyaction_5/0}).
-file("./day10_lexer.xrl", 15).
yyaction_5() ->
     skip_token .

-file("/usr/local/stow/erlang-19.1.6/lib/erlang/lib/parsetools-2.1.3/include/leexinc.hrl", 290).
