...
yystate(11, Ics, Line, Tlen, _, _) ->
    {3,Tlen,Ics,Line};
yystate(10, [99|Ics], Line, Tlen, Action, Alen) ->
...
yystate(7, [108|Ics], Line, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Tlen+1, Action, Alen);
...
yystate(2, Ics, Line, Tlen, _, _) ->
    {3,Tlen,Ics,Line,2};
yystate(1, [122|Ics], Line, Tlen, Action, Alen) ->
    yystate(13, Ics, Line, Tlen+1, Action, Alen);
...
-file("./day23_lexer.xrl", 9).
yyaction_0(TokenChars, TokenLine) ->
     { token, { unary, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("./day23_lexer.xrl", 10).
yyaction_1(TokenChars, TokenLine) ->
     { token, { binary, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("./day23_lexer.xrl", 11).
yyaction_2(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("./day23_lexer.xrl", 12).
yyaction_3(TokenChars, TokenLine) ->
     { token, { register, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_4/0}).
-file("./day23_lexer.xrl", 13).
yyaction_4() ->
     skip_token .
