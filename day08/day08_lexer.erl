...
yystate(17, [10|Ics], Line, Tlen, _, _) ->
    yystate(17, Ics, Line+1, Tlen+1, 5, Tlen);
...
-file("./day08_lexer.xrl", 6).
yyaction_0(TokenLine) ->
     { token, { rect, TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("./day08_lexer.xrl", 7).
yyaction_1(TokenLine) ->
     { token, { rotate, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("./day08_lexer.xrl", 8).
yyaction_2(TokenLine) ->
     { token, { row, TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("./day08_lexer.xrl", 9).
yyaction_3(TokenLine) ->
     { token, { col, TokenLine } } .

-compile({inline,yyaction_4/2}).
-file("./day08_lexer.xrl", 10).
yyaction_4(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_5/0}).
-file("./day08_lexer.xrl", 11).
yyaction_5() ->
     skip_token .
